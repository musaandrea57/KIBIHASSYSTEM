...
<div x-data="feeStructureBuilder()" class="space-y-6">
        ...
        <ol role="list" class="flex items-center space-x-4">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-sm font-medium text-gray-500" aria-current="page">Create New</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Fee Structure Builder</h2>
            <p class="mt-1 text-sm text-gray-500">Configure fee items, installments, and accounts.</p>
        </div>
    ...
    <form id="fee-structure-form" action="{{ route('admin.finance.fee-structures.store') }}" method="POST">
        @csrf
        ...
        <div class="bg-white shadow sm:rounded-lg mb-6 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-2">
                    ...
                    <input type="text" name="name" id="name" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="e.g. Nursing NTA4 Sem1 2025/2026">
                </div>
                <div>
...
<script>
    function feeStructureBuilder() {
        return {
            ...
            init() {
                // Initialize with at least one empty item if needed, or leave empty
                // this.addTuitionItem();
            }
        }
    }
